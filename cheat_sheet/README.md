...
| `terraform apply -replace="aws_instance.example" ` | Marks a resource for recreation during the next `terraform apply`.                    |
| `terraform apply -destroy="aws_instance.example" ` | Removes the taint from a resource.                                                    |
